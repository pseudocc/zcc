...
#define zvec_resize(this, n)                    \
  do {                                          \
    ...
    if ((n) > size) {                           \
      __zvec_grow(this, (n) * sizeof(this[0])); \
...
#define zvec_insert(this, it, v)                \
  ({                                            \
    ...
    p = __zvec_emplace(this, it, sizeof(*(it)));\
    if (p) *p = v;                              \
    p;                                          \
  })
...
#define zvec_insert_range(this, it, first, last)\
  ({                                            \
    ...
    p = __zvec_emplace(this, it, bytes);        \
